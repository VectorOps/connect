...
async def test_gemini_tool_call_and_tool_result_round_trip_live() -> None:
    ...
    _print_usage("gemini tool call alpha", first_tool_response)
    _print_usage("gemini tool result alpha", first_answer_response)
    _print_usage("gemini tool call beta", second_tool_response)
