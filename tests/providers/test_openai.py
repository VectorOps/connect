...
def test_default_provider_registry_exposes_implemented_providers() -> None:
    assert default_provider_registry.list() == ["anthropic", "chatgpt", "gemini", "openai", "openrouter"]


def test_anthropic_provider_is_registered() -> None:
    assert isinstance(default_provider_registry.get("anthropic"), AnthropicProvider)
